...
a2 = [ones(size(a2, 1), 1), a2];	% size(a2): [5000 x 26]
a3 = sigmoid(a2*Theta2');			% '

h = a3;								% size(h) : [5000 x 10]
...
cost_reg = (lambda/(2*m))*(sumsq(Theta1(:, 2:end)(:)) + sumsq(Theta2(:, 2:end)(:)));
J = J + cost_reg;
...
for t=1:m
	% step 1
	a1 = [1, X(t, :)];				% size(a1) : [1 x 401]
	
	z2 = Theta1*a1';				
	a2 = [1; sigmoid(z2)];			% size(a2) : [25 x 1]	'
